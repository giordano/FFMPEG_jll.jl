...
export libswresample, libswscale, libavdevice, libavresample, libavutil, libavformat, libavcodec, libpostproc, libavfilter, ffprobe, ffmpeg
...
const libavresample_splitpath = ["bin", "swresample-3.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libavresample = "swresample-3.dll"
...
function __init__()
    ...
    append!.(Ref(PATH_list), (libass_jll.PATH_list, libfdk_aac_jll.PATH_list, FriBidi_jll.PATH_list, FreeType2_jll.PATH_list, LAME_jll.PATH_list, libvorbis_jll.PATH_list, Ogg_jll.PATH_list, LibVPX_jll.PATH_list, x264_jll.PATH_list, x265_jll.PATH_list, Bzip2_jll.PATH_list, Zlib_jll.PATH_list, OpenSSL_jll.PATH_list, Opus_jll.PATH_list,))
    append!.(Ref(LIBPATH_list), (libass_jll.LIBPATH_list, libfdk_aac_jll.LIBPATH_list, FriBidi_jll.LIBPATH_list, FreeType2_jll.LIBPATH_list, LAME_jll.LIBPATH_list, libvorbis_jll.LIBPATH_list, Ogg_jll.LIBPATH_list, LibVPX_jll.LIBPATH_list, x264_jll.LIBPATH_list, x265_jll.LIBPATH_list, Bzip2_jll.LIBPATH_list, Zlib_jll.LIBPATH_list, OpenSSL_jll.LIBPATH_list, Opus_jll.LIBPATH_list,))

    global libswresample_path = abspath(joinpath(artifact"FFMPEG", libswresample_splitpath...))
    ...
    global libswscale_path = abspath(joinpath(artifact"FFMPEG", libswscale_splitpath...))
    ...
    global libavdevice_path = abspath(joinpath(artifact"FFMPEG", libavdevice_splitpath...))
    ...
    global libavresample_path = abspath(joinpath(artifact"FFMPEG", libavresample_splitpath...))
    ...
    global libavutil_path = abspath(joinpath(artifact"FFMPEG", libavutil_splitpath...))
    ...
    global libavformat_path = abspath(joinpath(artifact"FFMPEG", libavformat_splitpath...))
    ...
    global libavcodec_path = abspath(joinpath(artifact"FFMPEG", libavcodec_splitpath...))
    ...
    global libpostproc_path = abspath(joinpath(artifact"FFMPEG", libpostproc_splitpath...))
    ...
    global libavfilter_path = abspath(joinpath(artifact"FFMPEG", libavfilter_splitpath...))
    ...
    global ffprobe_path = abspath(joinpath(artifact"FFMPEG", ffprobe_splitpath...))

    push!(PATH_list, dirname(ffprobe_path))
    global ffmpeg_path = abspath(joinpath(artifact"FFMPEG", ffmpeg_splitpath...))
