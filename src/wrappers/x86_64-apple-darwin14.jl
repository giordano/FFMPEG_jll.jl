...
const libavcodec_splitpath = ["lib", "libavcodec.58.91.100.dylib"]
...
const libavdevice_splitpath = ["lib", "libavdevice.58.10.100.dylib"]
...
const libavfilter_splitpath = ["lib", "libavfilter.7.85.100.dylib"]
...
const libavformat_splitpath = ["lib", "libavformat.58.45.100.dylib"]
...
const libavutil_splitpath = ["lib", "libavutil.56.51.100.dylib"]
...
const libpostproc_splitpath = ["lib", "libpostproc.55.7.100.dylib"]
...
const libswresample_splitpath = ["lib", "libswresample.3.7.100.dylib"]
...
const libswscale_splitpath = ["lib", "libswscale.5.7.100.dylib"]
